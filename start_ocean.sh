...
export AQUARIUS_VERSION=${AQUARIUS_VERSION:-v4.0.8}
export PROVIDER_VERSION=${PROVIDER_VERSION:-v1.0.9}
export SUBGRAPH_VERSION=${SUBGRAPH_VERSION:-v4main}
export CONTRACTS_VERSION=${CONTRACTS_VERSION:-v1.0.0-alpha.34}
