...
export BRIZO_VERSION=${BRIZO_VERSION:-v0.7.0}
...
export COMMONS_SERVER_VERSION=${COMMONS_SERVER_VERSION:-v2.0.0-beta.2}
export COMMONS_CLIENT_VERSION=${COMMONS_CLIENT_VERSION:-v2.0.0-beta.2}
